...
litehtml::render_command_container::~render_command_container() {
}
...
int litehtml::render_command_container::get_default_font_size() const {
    return default_font_size;
}

const litehtml::tchar_t * litehtml::render_command_container::get_default_font_name() const {
    return _t("Arial");
}

void litehtml::render_command_container::draw_list_marker(litehtml::uint_ptr hdc, const litehtml::list_marker & marker) {
...
void litehtml::render_command_container::get_image_size(const litehtml::tchar_t * src, const litehtml::tchar_t * baseurl, litehtml::size & sz) {
...
void litehtml::render_command_container::draw_background(litehtml::uint_ptr hdc, const litehtml::background_paint & bg) {
...
void litehtml::render_command_container::set_caption(const litehtml::tchar_t * caption) {
    //wprintf(_t("set_caption: %s\n"), caption);
}

void litehtml::render_command_container::set_base_url(const litehtml::tchar_t * base_url) {
    //wprintf(_t("set_base_url: %s\n"), base_url);
}

void litehtml::render_command_container::link(const std::shared_ptr<litehtml::document>& doc, const litehtml::element::ptr & el) {
    //printf("link\n");
}

void litehtml::render_command_container::on_anchor_click(const litehtml::tchar_t * url, const litehtml::element::ptr & el) {
    on_anchor_click_ex(url, el, true);
}

void litehtml::render_command_container::on_anchor_click_ex(const litehtml::tchar_t * url, const litehtml::element::ptr & el, bool add_touch_rect) {
...
void litehtml::render_command_container::set_cursor(const litehtml::tchar_t * cursor) {
    //printf("set_cursor\n");
}

void litehtml::render_command_container::transform_text(litehtml::tstring & text, litehtml::text_transform tt) {
    //printf("transform_text\n");
}

void litehtml::render_command_container::import_css(litehtml::tstring & text, const litehtml::tstring & url, litehtml::tstring & baseurl) {
    //printf("import_css\n");
}

void litehtml::render_command_container::set_clip(const litehtml::position & pos, const litehtml::border_radiuses & bdr_radius, bool valid_x, bool valid_y) {
    //printf("set_clip\n");
}

void litehtml::render_command_container::del_clip() {
    //printf("del_clip\n");
}

void litehtml::render_command_container::get_client_rect(litehtml::position & client) const {
    client.x = 0;
    client.y = 0;
...
std::shared_ptr<litehtml::element> litehtml::render_command_container::create_element(const litehtml::tchar_t * tag_name, const litehtml::string_map & attributes, const std::shared_ptr<litehtml::document>& doc) {
...
void litehtml::render_command_container::get_media_features(litehtml::media_features & media) const {
}

void litehtml::render_command_container::get_language(litehtml::tstring & language, litehtml::tstring & culture) const {
}

void litehtml::render_command_container::set_client_size(int client_width, int client_height) {
