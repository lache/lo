...
void reset_runtime_context(LWCONTEXT* pLwc) {
    ...
    const LWBUTTONCOMMAND handler_array[] = {
        ...
        { LWU("Dynamic\nVBO"), change_to_dynamic_vbo },
        { LWU("Tilemap"), change_to_tilemap },
        { LWU("Runtime\nReset"), reset_runtime_context_async },
        { LWU("Font\nDebug"), toggle_font_texture_test_mode },
        { LWU("UDP"), net_rtt_test },
        { LWU("Skin"), change_to_skin },
        { LWU("Puck\nGame"), change_to_puck_game },
        { LWU("Particles"), change_to_particle_system },
        { LWU("Field\n1"), load_field_1_init_runtime_data },
        { LWU("Field\n2"), load_field_2_init_runtime_data },
        { LWU("Field\n3"), load_field_3_init_runtime_data },
        { LWU("Field\n4"), load_field_4_init_runtime_data },
        { LWU("Field\n5"), load_field_5_init_runtime_data },
        { LWU("Field\n6"), load_field_6_init_runtime_data },
        { LWU("UI"), change_to_ui },
        { LWU("Splash"), change_to_splash },
        { LWU("Server\n#0"), connect_to_server_0 },
        { LWU("Server\n#1"), connect_to_server_1 },
        { LWU("Ray\nTest\nToggle\n***"), toggle_ray_test },
        { LWU("Network\nToggle"), toggle_network_poll },
        { LWU("Nickname"), start_nickname_text_input_activity },
        { LWU("Push\nToken"), start_request_push_token },
        { LWU("TCP\nAddress"), start_tcp_addr_text_input_activity },
        { LWU("Stat\nToggle"), toggle_stat },
        { LWU("Reward\nVideo"), start_reward_video },
        { LWU("Sign\nIn"), start_sign_in },
        { LWU("Sign\nOut"), start_sign_out },
