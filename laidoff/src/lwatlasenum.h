...
typedef enum _LW_ATLAS_ENUM {
    ...
    LAE_WATER_SAND_TILE,
    LAE_WATER_SAND_TILE_GRID_1X,
    LAE_WATER_SAND_TILE_GRID_2X,
    LAE_WATER_SAND_TILE_GRID_4X,
    LAE_WATER_SAND_TILE_GRID_8X,
    LAE_WATER_SAND_TILE_GRID_16X,
...
static const char *tex_atlas_filename[] = {
    ...
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "captain0.ktx",
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "ship0.ktx",
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "water_2048x1024_aa.ktx",
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "water-sand-tile.ktx",
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "water-sand-tile-grid-1x.ktx",
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "water-sand-tile-grid-2x.ktx",
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "water-sand-tile-grid-4x.ktx",
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "water-sand-tile-grid-8x.ktx",
    ASSETS_BASE_PATH "ktx" PATH_SEPARATOR "water-sand-tile-grid-16x.ktx",
