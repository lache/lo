...
#define LNGLAT_SEA_CELL_UNIT_PER_DEGREES (LNGLAT_RES_HEIGHT/180.0)
#define LNGLAT_SEA_PING_EXTENT_IN_DEGREES ((180.0/LNGLAT_RES_HEIGHT)*LNGLAT_SEA_PING_EXTENT_IN_CELL_PIXELS)
